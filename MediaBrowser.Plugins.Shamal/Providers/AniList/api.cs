    ...
    characters(page: $page, sort: [ROLE]) {
      ...
      edges {
        ...
        public async Task<RemoteSearchResult> GetAnime(string id)
        {
            ...
            result.ImageUrl = WebContent.data.Media.coverImage.extraLarge;
        ...
        {
            return WebContent.data.Media.coverImage.extraLarge;
        }

        public string Get_ImageBannerUrl(RootObject WebContent)
        {
